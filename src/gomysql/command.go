...
func (my *MySQL) sendCmd(cmd byte) {
	my.seq = 0
...
func (my *MySQL) sendCmdStr(cmd byte, s string) {
	my.seq = 0
...
func (my *MySQL) sendCmdU32(cmd byte, u uint32) {
	my.seq = 0
...
func (my *MySQL) sendLongData(stmtid uint32, pnum uint16, data []byte) {
	my.seq = 0
